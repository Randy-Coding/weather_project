...
def clean_up(weather: pd.DataFrame):
...
weather = clean_up(input)
weather = weather[weather["time"] == "2024-03-10 15:00:00"]

# Save the filtered DataFrame to a CSV file
weather.to_csv("prediction_input_cleaned.csv", index=False)
